<h3>SentinelFlow K8s | Automated CI/CD pipeline to build, scan, and deploy a containerized FastAPI application on Kubernetes with full observability.</h3>
...
<p>End-to-end DevOps architecture showcasing CI/CD automation, Kubernetes orchestration, and observability pipeline <br></p>
<p align="center">
